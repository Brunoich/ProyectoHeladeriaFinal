...
public class DetalleFormBean implements Serializable{
    ...
    public String confirmarPago(){
        ...
        getFactura().setModopago(getModoPago());
        getFactura().setFecha(new Date());
        getFactura().setUsuarios((Usuario) FacesContext.getCurrentInstance().getExternalContext().getSessionMap().get("usuarioValidado"));
